...
export const MotionCardExample: React.FC = () => {
  return (
    <div className="p-8 space-y-8">
      ...
      <MotionCard variants={scaleVariants} className="bg-primary/5 border-primary/20">
      ...
      {/* Clickable Card */}
      <MotionCard onClick={() => alert("Card clicked!")} className="hover:border-primary/50">
      ...
      <MotionContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <MotionItem key={item}>
            <MotionCard variants={fadeInVariants}>
