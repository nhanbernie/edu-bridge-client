        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-card rounded-3xl shadow-lg border border-border p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("stats.totalEarnings.title")}</p>
          ...
          <div className="bg-card rounded-3xl shadow-lg border border-border p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("stats.totalSpent.title")}</p>
                <p className="text-2xl font-bold text-foreground">{formatCurrency(totalSpent)}</p>
                <p className="text-xs text-muted-foreground">{t("stats.totalSpent.description")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-3xl shadow-lg border border-border p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("stats.completed.title")}</p>
          ...
          <div className="bg-card rounded-3xl shadow-lg border border-border p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">{t("stats.pending.title")}</p>
                <p className="text-2xl font-bold text-foreground">{pendingTransactions}</p>
                <p className="text-xs text-muted-foreground">{t("stats.pending.description")}</p>
              </div>
            </div>
          </div>
        </div>
