            ...
            {upcomingSessions.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                  Bạn chưa có buổi dạy nào được lên lịch. Hãy tạo khóa học để bắt đầu dạy!
                </p>
              </div>
            ) : (
