    ...
    <RoleGuard allowedRoles={["ADMIN"]} requiredStatus={["APPROVED"]}>
      <AdminLayout>
        <MotionContainer className="space-y-8">
          {/* Header */}
          <MotionItem variants={fadeInVariants}>
          ...
          <MotionContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {statsData.map((stat) => (
              <MotionItem key={stat.title} variants={cardVariants}>
                <MotionCard
          ...
          <MotionItem variants={slideUpVariants}>
            <MotionCard className="border-0 shadow-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm text-blue-700 dark:text-blue-300">
                          ...
                          <ul className="space-y-1 text-xs">
                            ...
                            <li>
                              • <strong>TRUSTED_BEGINNER:</strong> New but trustworthy tutors
